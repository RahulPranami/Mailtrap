...
class Mailtrap_API {
	...
	public static function getInbox() {
		$response = wp_remote_get(
			self::BASE_URL . '/inboxes/' . get_option( 'mailtrap_inbox_id' ),
			array(
				'headers' => array(
					'Api-Token' => get_option( 'mailtrap_api_token' ),
				),
	...
	public static function getInboxMessages() {
		$response = wp_remote_get(
			self::BASE_URL . '/inboxes/' . get_option( 'mailtrap_inbox_id' ) . '/messages',
			array(
				'headers' => array(
					'Api-Token' => get_option( 'mailtrap_api_token' ),
				),
	...
	public static function getMessage( $message_id ) {
		$response = wp_remote_get(
			self::BASE_URL . '/inboxes/' . get_option( 'mailtrap_inbox_id' ) . '/messages/' . $message_id,
			array(
				'headers' => array(
					'Api-Token' => get_option( 'mailtrap_api_token' ),
				),
	...
	public static function getMessageBody( $message_id, $format = 'html' ) {
		$response = wp_remote_get(
			self::BASE_URL . '/inboxes/' . get_option( 'mailtrap_inbox_id' ) . '/messages/' . $message_id . '/body.' . $format,
			array(
				'headers' => array(
					'Api-Token' => get_option( 'mailtrap_api_token' ),
				),
